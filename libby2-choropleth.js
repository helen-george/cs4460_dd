...
Promise.all([
    d3.csv("libby2-NfipCommunityStatusBook.csv"),
    d3.json("libby2-new-us-states.json")  // Use the new GeoJSON file
]).then(([data, geoData]) => {
    ...
    const colorScale = d3.scaleLinear()
        .domain([0, 100]) // Non-participation percentage range from 0% to 100%
        .range(["#fde0dd", "#67001f"]); // Custom colors: light pink to dark red
